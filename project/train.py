...
"""Modified from https://github.com/microsoft/torchgeo/blob/main/train.py"""
...
def main(conf: DictConfig) -> None:
    ...
    if "swa_lrs" in conf:
        ...
        swa = StochasticWeightAveraging(swa_lrs=conf.swa_lrs)
        trainer_args["callbacks"].append(swa)
